class Assistant::Function::SearchFamilyFiles < Assistant::Function
  ...
  def call(params = {})
    return { success: false, error: "unavailable", message: "Document search is not available with ChatGPT subscription mode." } if Provider::Codex.selected? || Ai::Features.managed?(user.family)
